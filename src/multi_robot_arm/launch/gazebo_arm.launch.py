...
# RUN THIS ros2 launch multi_robot_arm gazebo_arm.launch.py
...
def generate_launch_description():
    ...
    robots = [
            {'name': 'arm1', 'x_pose': '0.0', 'y_pose': '0.0', 'Y':'0.0'},
...
def spawn_robot(
    ...
    message = """ {
            ...
            'points': [
                {
                'positions': [0.01, 4.34, -2.08, -0.68, 1.57, 1.588],
                'velocities': [],
                'accelerations': [],
                'effort': [],
                'time_from_start': {
